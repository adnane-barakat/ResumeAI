...
function Loginboard() {
    ...
    const handleSubmitSignup = (e)=> {
        e.preventDefault();
        axios.post('http://localhost:8020/signup',{email,password , passwordConfirm})
            .then(res => {
                console.log(res);
        ...
        <div>
            {showLogin ? (<div className="form-container">
                ...
                <div className="social-icons">
                    ...
                    <button aria-label="Log in with Facebook" className="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                             className="w-5 h-5 fill-current">
                            <path
                                d="M22.675 0h-21.348C0.593 0 0 0.593 0 1.325v21.348c0 0.732 0.593 1.325 1.325 1.325h11.495v-9.294h-3.224v-3.622h3.224v-2.667c0-3.202 1.902-5.017 5.005-5.017 1.452 0 2.698 0.108 3.054 0.156v3.125h-2.086c-1.635 0-1.958 0.776-1.958 1.907v2.334h3.385l-0.437 3.622h-2.948v9.294h5.734c0.732 0 1.325-0.593 1.325-1.325V1.325C24 0.593 23.407 0 22.675 0z"/>
                        </svg>
                    </button>
                ...
                <p className="signup">
                    ...
                    <a rel="noopener noreferrer" href="#" className="" onClick={handleToggle}>Sign up</a>
                </p>
            </div>) : (
                <div className="form-container">
                    ...
                    <form className="form" onSubmit={handleSubmitSignup}>
                        ...
                        <div className="input-group">
                            ...
                            <input type="password" name="password" id="password" placeholder="" onChange={e  => setPasswordConfirm(e.target.value)}/>
                        </div>
                        <br/>
                        {error && <p style={{ color: 'red' }}>{error}</p>}
                    ...
                    <p className="signup">
                        ...
                        <a rel="noopener noreferrer" href="#" className="" onClick={handleToggle}>Login</a>
                    </p>
                </div>
            )}
